...
PATIENCE_HEAD = 12
PATIENCE_FINE = 4
FEAT_NOISE    = 0.02     # Gaussian noise std added
SEED          = 42
...
# PART 2: Head training with feature noise
...
# PART 3: Fine-tune last 2 backbone blocks on original images 
...
def tta_predict_batch(img_paths):
    ...
    for tf in tta_tfs:
        ...
        for path in img_paths:
            ...
            probs_list.append(p)
        all_probs.append(np.stack(probs_list)) 
